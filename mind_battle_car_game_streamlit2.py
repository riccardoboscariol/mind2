...
def main():
    ...
    def end_race(winner):
        ...
        if consent_answer == "No":
            # Save race data with "No" in the last column
            race_data = [
                ...
                "No"  # Record "No" if user does not consent
            ]
            save_race_data(sheet1, race_data)
        elif consent_answer == "Sì":
            # Display the submit button for "Sì"
