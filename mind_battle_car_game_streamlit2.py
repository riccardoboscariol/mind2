...
def main():
    ...
    st.markdown("""
        ...
        .number-image {
            position: absolute;
            top: -60px; /* Aggiustamento per posizionare il numero sopra l'auto */
            width: 80px; /* Dimensione ridotta delle immagini numeriche */
            opacity: 0.1; /* Riduzione della trasparenza per renderle più visibili */
        }
        .flag-image {
            position: absolute;
            top: -100px;
