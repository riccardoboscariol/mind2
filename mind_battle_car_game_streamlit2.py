...
def main():
    ...
    st.markdown(
        ...
        .number-image {{
            position: absolute;
            top: 35px;  /* Move images 1px lower */
            left: calc(50% - 67px); /* Center numbers under cars, 7px to the left */
        ...
        <link rel="stylesheet" href="{unique_query_string}">
        """,
        ...
        car_placeholder.markdown(
            ...
            <div class="slider-container first">
                ...
                <img src="data:image/png;base64,{red_car_number_base64}" class="number-image {'show' if st.session_state.player_choice is not None else ''}" 
                     style="left:calc({st.session_state.car_pos / 10}% + 6.8%); top: 41px; z-index: 10;">
        ...
        car2_placeholder.markdown(
            ...
            <div class="slider-container">
                ...
                <img src="data:image/png;base64,{green_car_number_base64}" class="number-image {'show' if st.session_state.player_choice is not None else ''}" 
                     style="left:calc({st.session_state.car2_pos / 10}% + 6.8%); top: 41px; z-index: 10;">
