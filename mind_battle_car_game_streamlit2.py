...
def main():
    ...
    st.markdown(
        ...
        .number-image {
            position: absolute;
            top: 45.5px;  /* Position for numbers, 5px higher */
            left: calc(50% - 71px); /* Center numbers under cars, 1px left */
        ...
        .flag-image {
            position: absolute;
            top: 25px;  /* Position for flag 2px higher */
            width: 150px;
        ...
        car_placeholder.markdown(
            ...
            <div class="slider-container first">
                ...
                <img src="data:image/png;base64,{red_car_number_base64}" class="number-image {'show' if st.session_state.player_choice is not None else ''}" 
                     style="left:calc(-71px + {st.session_state.car_pos / 10}%); top: 45.5px; z-index: 10;">
        ...
        car2_placeholder.markdown(
            ...
            <div class="slider-container">
                ...
                <img src="data:image/png;base64,{green_car_number_base64}" class="number-image {'show' if st.session_state.player_choice is not None else ''}" 
                     style="left:calc(-71px + {st.session_state.car2_pos / 10}%); top: 45.5px; z-index: 10;">
